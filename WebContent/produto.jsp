                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="midlet">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-2">
                                              <input class="form-control" id="cd_hosp" name="codigo" type="text" value="${hospedagem.codigoHospedagem}" readonly="readonly" />
                                          </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-5" style="margin-top: 8px;">
                                              <input class="form-control" id="valor_total" name="valor_total"  readonly="readonly" />
                                          </div>
                                      </div> 
