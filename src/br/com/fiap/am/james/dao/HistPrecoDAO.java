...
public class HistPrecoDAO {
	...
	public List<HistPrecoBean> selectAll (Connection conexao) throws Exception {
		List<HistPrecoBean> lstHistPreco = new ArrayList<HistPrecoBean>();
		HistPrecoBean hp = null;
		ProdutoServicoBean ps = null;
		Calendar cal = null;
		stmt = conexao.prepareStatement("SELECT HP.CD_HIST_PRECO, HP.CD_TIPO_SERVICO, HP.DT_VALIDADE, HP.VL_PRECO "
